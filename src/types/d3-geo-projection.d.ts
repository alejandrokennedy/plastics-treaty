declare module 'd3-geo-projection' {
  ...
  export function geoChamberlin(point1: [number, number], point2: [number, number], point3: [number, number]): GeoProjection;
  ...
  export function geoModifiedStereographic(coefficients: number[][], rotate: [number, number]): GeoProjection;
